...
pub type Precompiles<R> =
	PrecompileSetBuilder<R, (PrecompileAt<AddressU64<1>, DaoDemocracyPrecompile<R>>,)>;

pub type PCall = DaoDemocracyPrecompile<Runtime>;
...
impl Default for ExtBuilder {
	fn default() -> ExtBuilder {
		ExtBuilder { balances: vec![], referenda: vec![] }
	}
}
...
pub(crate) fn set_balance_proposal(
	...
	let who = who.into();
	let inner = pallet_balances::Call::set_balance { who, new_free: value, new_reserved: 0 };
